                    ...
                    {user ? (
                        <div className="relative flex items-center gap-3">
                            ...
                            <img
                                ...
                                title={user.displayName} // Tooltip with user display name
                            />
                            ...
                            {/* Logout Button */}
                            <button onClick={logoutUser} className="mt-2 text-white bg-[#2ecc71] px-4 py-2 rounded hover:bg-[#1ebb9e] transition w-full">Logout</button>
                        </div>
                    ) : (
                        // Login Button
